package com.core.lib_core.fragmentation.debug;
...
import com.core.lib_core.utils.ScreenUtils;
...
public class DebugHierarchyViewContainer extends ScrollView {
    ...
    private void initView(Context context) {
        ...
        mItemHeight = ScreenUtils.dip2px(context, 50);
        mPadding = ScreenUtils.dip2px(context, 16);
    }
    ...
    private LinearLayout getTitleLayout() {
        ...
        mTitleLayout.setPadding(ScreenUtils.dip2px(mContext, 24), ScreenUtils.dip2px(mContext, 24), 0, ScreenUtils.dip2px(mContext, 8));
        ...
        params.leftMargin = ScreenUtils.dip2px(mContext, 16);
