...
package com.core.lib_core.systembar;
...
public class SystemBarTintManager {
	 ...
	 * 
	 * If the platform does not have soft navigation keys, is running Jelly Bean or earlier, or translucent system UI modes have not been enabled in either the theme or via window flags, then this
	 * method does nothing.
	 * 
	 * @param enabled
	 *            True to enable tinting, false to disable it (default).
