package com.core.lib_core.widgets.progress;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimension(R.styleable.CircularProgress_bor_width,
                DEFAULT_BORDER_WIDTH * density);
        oneColor = a.getColor(R.styleable.CircularProgress_circle_color, getResources().getColor(R.color.blue));
        a.recycle();
        mColors = new int[1];
        mColors[0] = oneColor;
