package com.core.lib_core.widgets.viewhelper;

import android.view.View;

import com.core.lib_core.R;
import com.core.lib_core.widgets.ProgressWheel;

/**
 * Created by joker on 2016/11/1.
...
public class VaryViewHelper {
    ...
    public void setUpErrorView(View view, View.OnClickListener listener) {
        ...
        View btn = view.findViewById(R.id.core_error_refresh);
        if (btn != null) {
    ...
    public void setUpLoadingView(View view) {
        ...
        mLoadingProgress = (ProgressWheel) view.findViewById(R.id.core_loading_progress);
    }
